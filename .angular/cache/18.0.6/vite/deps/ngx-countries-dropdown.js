...
var getCountriesBasedOnSearch = (countriesToSearch, searchText) => {
  return countriesToSearch.filter((x) => x.name?.toLowerCase()?.includes(searchText?.toLowerCase()) || x.dialling_code?.toLowerCase()?.includes(searchText?.toLowerCase()));
};
var _CountryListComponent = class _CountryListComponent {
  constructor() {
...
_CountryListComponent.ɵfac = function CountryListComponent_Factory(t) {
  return new (t || _CountryListComponent)();
};
_CountryListComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function CountryListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(2, CountryListComponent_Conditional_2_Template, 10, 9, "div", 4)(3, CountryListComponent_Conditional_3_Template, 3, 0, "div");
      ɵɵelement(4, "div", 5);
      ɵɵelementEnd();
...
var CountryListComponent = _CountryListComponent;
(() => {
...
var _NgxCountriesDropdownModule = class _NgxCountriesDropdownModule {
};
_NgxCountriesDropdownModule.ɵfac = function NgxCountriesDropdownModule_Factory(t) {
  return new (t || _NgxCountriesDropdownModule)();
};
_NgxCountriesDropdownModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxCountriesDropdownModule,
  imports: [CountryListComponent],
  exports: [CountryListComponent]
});
_NgxCountriesDropdownModule.ɵinj = ɵɵdefineInjector({
  imports: [CountryListComponent]
});
var NgxCountriesDropdownModule = _NgxCountriesDropdownModule;
(() => {
